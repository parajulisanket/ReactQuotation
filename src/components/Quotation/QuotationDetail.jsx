...
//     // Clone the node to modify safely
//     const clone = element.cloneNode(true);

//     // Forcefully remove visual borders/shadows that can appear in PDF
...
//         <div className="my-20">
//           <div className="grid grid-cols-2 bg-[#034cc6] text-white p-4 font-bold mb-2">
